...
│   ├── extract.py       # чтение данных из 5 источников

│   ├── transform.py     # очистка, валидация, логирование

│   ├── load.py          # загрузка в staging и DWH
...
│   │   └── 01_dwh.sql   # DDL таблиц Star Schema
...
│   └── bad_records.csv  # лог проблемных записей
